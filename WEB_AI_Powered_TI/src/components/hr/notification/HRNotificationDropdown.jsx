  ...
  return (
    <div ref={dropdownRef} className="relative flex-shrink-0">
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            {/* Overlay chỉ hiện trên mobile để bấm ra ngoài đóng dropdown */}
            <div
            ...
            <motion.div
              ...
              className="fixed left-3 right-3 top-[62px] max-h-[80vh]
                sm:absolute sm:left-auto sm:top-auto sm:right-0 sm:mt-2
                w-auto sm:w-[400px] max-w-none sm:max-w-[400px]
